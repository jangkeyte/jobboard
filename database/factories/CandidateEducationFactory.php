...
class CandidateEducationFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'level' => fake()->randomElement(['Mẫu giáo', 'Trung học cơ sở', 'Trung học phổ thông', 'Đại học', 'Cao học']),
            'institute' => fake()->randomElement(['Đại học', 'Trung cấp', 'Cao đẳng', 'Học viện', 'Trường nghề']) . ' ' . fake()->name() . ' ' . fake()->randomElement($data),
            'degree' => fake()->randomElement(['Tiến sĩ', 'Thạc sĩ', 'Cử nhân', 'Tốt nghiệp trung học']),
            'passing_year' => fake()->date('Y')
        ];
    }
}

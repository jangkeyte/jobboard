...
Route::group(['middleware' => 'locale'], function() {
    ...
    Route::middleware(['candidate:candidate'])->group(function() {
        ...
        Route::post('/candidate/skill/update', [CandidateController::class, 'skill_update'])->name('candidate_skill_update');
        ...
        Route::get('/candidate/work-experience/create', [CandidateController::class, 'work_experience_create'])->name('candidate_work_experience_create');
        ...
        Route::post('/candidate/work-experience/update', [CandidateController::class, 'work_experience_update'])->name('candidate_work_experience_update');
    ...
    Route::middleware(['admin:admin'])->group(function() {
        ...
        Route::post('/admin/faq/update', [AdminFaqController::class, 'update'])->name('admin_faq_update');
        ...
        Route::post('/admin/package/update', [AdminPackageController::class, 'update'])->name('admin_package_update');
        ...
        Route::post('/admin/job-location/update', [AdminJobLocationController::class, 'update'])->name('admin_job_location_update');
        ...
        Route::post('/admin/job-type/update', [AdminJobTypeController::class, 'update'])->name('admin_job_type_update');
        ...
        Route::post('/admin/job-experience/update', [AdminJobExperienceController::class, 'update'])->name('admin_job_experience_update');
        ...
        Route::post('/admin/job-gender/update', [AdminJobGenderController::class, 'update'])->name('admin_job_gender_update');
        ...
        Route::post('/admin/job-salary-range/update', [AdminJobSalaryRangeController::class, 'update'])->name('admin_job_salary_range_update');
        ...
        Route::post('/admin/company-location/update', [AdminCompanyLocationController::class, 'update'])->name('admin_company_location_update');
        ...
        Route::post('/admin/company-industry/update', [AdminCompanyIndustryController::class, 'update'])->name('admin_company_industry_update');

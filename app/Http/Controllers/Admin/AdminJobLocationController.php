...
class AdminJobLocationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin_job_location')->with('success', __('Data is saved successfully.'));
    }
    ...
    {
        $obj = JobLocation::where('id', $request->id)->first();
        ...
        return redirect()->route('admin_job_location')->with('success', __('Data is updated successfully.'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('admin_job_location')->with('success', __('Data is deleted successfully.'));
    }

...
class AdminCompanyLocationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin_company_location')->with('success', __('Data is saved successfully.'));
    }
    ...
    {
        $obj = CompanyLocation::where('id', $request->id)->first();
        ...
        return redirect()->route('admin_company_location')->with('success', __('Data is updated successfully.'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('admin_company_location')->with('success', __('Data is deleted successfully.'));
    }

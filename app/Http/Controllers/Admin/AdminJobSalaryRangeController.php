...
class AdminJobSalaryRangeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin_job_salary_range')->with('success', __('Data is saved successfully.'));
    }
    ...
    {
        $obj = JobSalaryRange::where('id', $request->id)->first();
        ...
        return redirect()->route('admin_job_salary_range')->with('success', __('Data is updated successfully.'));
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('admin_job_salary_range')->with('success', __('Data is deleted successfully.'));
    }

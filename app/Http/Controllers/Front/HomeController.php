...
class HomeController extends Controller
{
    public function index()
    {
        ...
        return view('front.home', compact('home_page_data', 'job_categories', 'all_job_categories', 'all_job_locations', 'all_job_types', 'all_job_experiences', 'all_job_salary_ranges', 'why_choose_items', 'testimonials', 'posts', 'featured_jobs'));
    }

...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $companies = \App\Models\Company::withCount('rJob')->orderBy('r_job_count', 'desc')->take(8)->get();
        ...
        return view('front.home', compact('home_page_data', 'job_categories', 'all_job_categories', 'all_job_locations', 'all_job_types', 'all_job_experiences', 'all_job_salary_ranges', 'why_choose_items', 'testimonials', 'posts', 'companies', 'featured_jobs', 'refered_jobs'));
    }

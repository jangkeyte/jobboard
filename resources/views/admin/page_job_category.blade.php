...
@section('main_content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin_job_category_page_update') }}">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="meta_description" class="form-control" cols="30" rows="5">{{ $page_job_category_data?->meta_description }}</textarea>
                        </div>

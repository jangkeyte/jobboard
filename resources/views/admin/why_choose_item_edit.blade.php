...
@section('main_content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin_why_choose_item_update') }}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id" value="{{ $why_choose_item_single->id }}">
                        <div class="form-group mb-3">
                            <label>Icon Preview</label>
                            <div><i class="{{ $why_choose_item_single->icon }}"></i></div>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            <label>Text *</label>
                            <textarea name="text" class="form-control" cols="30" rows="10">{{ $why_choose_item_single->text }}</textarea>
                        </div>
